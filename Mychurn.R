...
churn <- read.csv("churn.csv" ,header=T ,sep = ",", stringsAsFactors = F)
View(churn)
...
##################################################################
# Box plots for numeric variables to look for outliers
##################################################################
boxplot(churn$tenure)
boxplot(churn$MonthlyCharges)
boxplot(churn$TotalCharges)

# No Outliers detected from the box plots 
...
# Convert Tenure to years for more convenient/clear analysis
